...
export function ExportFilenames({ filenames, downloadName, label = 'Export .txt' }: {
  ...
  return (
    <button
      ...
      className="inline-flex items-center gap-1.5 rounded-md border border-border bg-surface px-3 py-1.5 text-xs font-bold uppercase tracking-wider text-ink-strong hover:bg-surface-2 hover:border-border-strong transition-colors disabled:opacity-40"
    >
