...
export function ThemeToggle() {
  ...
  return (
    <button
      ...
      title={label}
      onClick={cycle}
      className="inline-flex h-10 w-10 items-center justify-center rounded-md bg-surface border-2 border-border text-ink-strong hover:bg-surface-2 active:scale-95 transition-[transform,background-color] duration-150"
    >
