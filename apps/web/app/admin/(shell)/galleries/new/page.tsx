...
export default function NewGalleryPage() {
  ...
  async function onSubmit(e: React.FormEvent) {
    ...
    if (eventDate)
      payload.eventDate = Math.floor(new Date(eventDate).getTime() / 1000);
    ...
    <div>
      <header className="p-4 border-b border-border">
        ...
        <p className="mt-2 text-sm text-ink-muted">
          A blank canvas. You can add photos and tweak settings after it's
          created.
        </p>
      </header>
          ...
          <section className="rounded-xl bg-surface border border-border p-4 space-y-4">
            ...
            <Field id="subtitle" label="Subtitle" hint="optional">
              <Textarea
                ...
                placeholder="A weekend in Mendoza"
              />
            </Field>
            ...
            <Field
              ...
              hint="leave blank for public access"
            >
              <TextInput
                id="password"
                type="password"
