    ...
    <form onSubmit={(e) => e.preventDefault()} className="space-y-6">
          ...
          <Field id="status" label="Status">
            <Select
              ...
              onChange={immediate((v) => {
                setStatus(v);
                broadcastGalleryStatus(gallery.id, v);
              })}
              options={[
        ...
        <div className="grid gap-6 sm:grid-cols-2">
          <Field id="eventDate" label="Event date">
            <DateField
              id="eventDate"
              value={eventDate}
              onChange={immediate(setEventDate)}
              placeholder="No date"
            />
          </Field>
        ...
        <div className="grid gap-6 sm:grid-cols-2">
          <Field id="expiresAt" label="Expires on" hint="optional">
            <DateField
              id="expiresAt"
              value={expiresAt}
              onChange={immediate(setExpiresAt)}
              placeholder="Never"
            />
          </Field>
          <Field
      ...
      <Section title="Permissions">
        <Toggle
          ...
          onChange={immediate(setAllowFavorites)}
          label="Favorites"
        ...
        <Toggle
          ...
          onChange={immediate(setAllowComments)}
          label="Comments"
        ...
        <Toggle
          ...
          onChange={immediate(setAllowDownload)}
          label="Downloads"
        ...
        <Toggle
          ...
          onChange={immediate(setNotifyOnView)}
      ...
      <Section title="Delivery">
        <Field id="downloadMode" label="Download mode">
          <Select
            id="downloadMode"
            value={downloadMode}
            onChange={immediate(setDownloadMode)}
            options={[
              {
                value: "watermarked",
...
function SaveStatus({ state }: { state: SaveState }) {
  ...
  return (
    <span className={`${base} text-ink-subtle`}>
